...
%%% COIL GEOMETRY
for i=1:length(pos)
    namer1=['ic1_',num2str(i)];
    namer2=['ic2_',num2str(i)];
    namer3=['ic3_',num2str(i)];
    namer4=['ic4_',num2str(i)];
    
    model.component('comp1').geom('geom1').create(namer1, 'InterpolationCurve');
model.component('comp1').geom('geom1').feature(namer1).set('contributeto', 'csel1');
model.component('comp1').geom('geom1').feature(namer1).set('table', [pos(i) 2 3; pos(i) 2 -3]);
model.component('comp1').geom('geom1').create(namer2, 'InterpolationCurve');
model.component('comp1').geom('geom1').feature(namer2).set('contributeto', 'csel1');
model.component('comp1').geom('geom1').feature(namer2).set('table', [pos(i) 2 -3; pos(i) -2 -3]);
model.component('comp1').geom('geom1').create(namer3, 'InterpolationCurve');
model.component('comp1').geom('geom1').feature(namer3).set('contributeto', 'csel1');
model.component('comp1').geom('geom1').feature(namer3).set('table', [pos(i) -2 -3; pos(i) -2 3]);
model.component('comp1').geom('geom1').create(namer4, 'InterpolationCurve');
model.component('comp1').geom('geom1').feature(namer4).set('contributeto', 'csel1');
model.component('comp1').geom('geom1').feature(namer4).set('table', [pos(i) -2 3; pos(i) 2 3]);
